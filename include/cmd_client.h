...
{
    SERVER = 0, NICK, LIST, JOIN, PART, USERS, SEND_FILE,
    ACCEPT_FILE, HELP, EXIT, NO_CMD
}   COMMAND;

static const char *cmdlist_str[] =
{
  "/SERVER", "/NICK", "/LIST", "/JOIN", "/PART", "/USERS",
  "/SEND_FILE", "/ACCEPT_FILE", "/HELP", "/EXIT"
};
...
{
  &irc_server, &irc_nick, &irc_list, &irc_join, &irc_part, &irc_users,
  &irc_send_file, &irc_accept_file, &irc_help, &irc_exit
};
