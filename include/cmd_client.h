...
{
    SERVER = 0, NICK, USER, LIST, JOIN, PART, USERS, MSG, SEND_FILE,
...
static const char *cmdlist_str[] =
{
  ...
  "/MSG", "/SEND_FILE", "/ACCEPT_FILE", "/HELP", "/QUIT"
};
...
static cmdlist_ptr cmdlist_func[] =
{
  ...
  &irc_users, &irc_msg, &irc_send_file, &irc_accept_file, &irc_help, &irc_quit
};
